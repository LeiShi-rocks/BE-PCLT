...
```{r}
saveRDS(results, file = "Revision-202505/sim_results_parallel_small.rds")
```
...
```{r}
# report results
record <- readRDS("Revision-202505/sim_results_parallel_small.rds")
```
...
ggsave(
  "Revision-202505/BE_PCLT_SMALL_EFFECTS_EXPN_K.pdf",
  plot = plot_SE,
  device = "pdf", 
  dpi = 300
)
