...
library('factoextra') # Load package 'RcppArmadillo'
...
### The following are experimenting codes. If want to run simulation, head to next section!!
...
id_group_URP <- ceiling((1:sum(units_URP))/50) + sum(units_RP)
...
if (1) {
  ...
  km_fit <- kmeans(factorial_data_aug_URP$y, centers = 3, nstart = 25)
...
saveRDS(record, file="record_INCORRECT_SPEC.RData")
